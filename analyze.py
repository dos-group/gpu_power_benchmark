...
# Strip the soft-break placeholder used by the figure scripts.
df_all["hardware"] = df_all["hardware"].str.replace("<br>", " ", regex=False)
df_raw_all["hardware"] = df_raw_all["hardware"].str.replace("<br>", " ", regex=False)
